...
<div class="container-fluid mx-auto">
    <div class="container-fluid mt-5 mb-5">
      <div class="row">
          <div class="col-lg-3 col-md-6 mb-4 px-4">
              <div class="animate__animated animate__zoomIn bg-white rounded shadow p-4 border-4 border-top border-secondary text-center about-card">
    ...
    <div class="container mt-5">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-12 mb-4  order-md-1 order-lg-1 order-2 animate__animated animate__zoomIn">
            ...
            <div class="col-lg-6 col-12 mb-5 order-md-2 order-lg-2 order-1 m-0 p-0">
                <img src="images\about\about1.jpg" class="w-100 animate__animated animate__zoomIn">
            </div>
        </div>
    </div>
